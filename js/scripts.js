...
for(let i = 0; i < boxes.length; i++){
    ...
    boxes[i].addEventListener("click", function(){
        ...
        if(this.childNodes.length == 0){
            ...
            // clonando o elemento para poder usa-lo mais de uma vez
...
// evento para saber se é 2 jogadores ou contra IA
...
function checkEl(player1, player2){
    if(player1==player2){ // quem começa é a primeira partida é x
        // x
        el = x;
    } else{
        // o
